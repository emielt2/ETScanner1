...
public class TestGroovy1 extends GebReportingSpec{
    ...
    def void3(){
        when:
        //evaluate(new File("src/main//java/ETS1/GroovyClassTest.groovy"))
        //to ScanPage
        println "void3--"
        then:
        //at ScanPage
        def script1 = new GroovyScriptEngine( '' ).with {
            ...
            // loadScriptByName( '\\Users\\E\\ETScanner1\\target\\classes\\ETS1/GroovyClassTest.class' )
       ...
       // script1.invokeMethod(null,"Step1gct")
        ...
        def script3 = shell.parse(new File('src/main//java/ETS1/GroovyClassTest.groovy'))
       // script3.invokeMethod("a","")

        def script4 = new GroovyScriptEngine( '' ).with {
            loadScriptByName( 'src/main//java/ETS1/GroovyClassTest.groovy' )
        }
...
//HMM        gg.Step1gct();
        ...
        File sourceFile = new File("F://Users//E//ETScanner1//src//main//java/ETS1//GroovyClassTest.groovy");
...
//        evaluate(new File("src/main//java/ETS1/GroovyClassTest.groovy"))
        ...
        //"F://Users//E//ETScanner1//src//main//java/ETS1//GroovyClassTest.groovy".execute().Step1gct
        //"F:\\SeleniumDownloadFolder\\apache-groovy-binary-2.4.5\\groovy-2.4.5\\bin\\groovy F://Users//E//ETScanner1//src//main//java/ETS1//GroovyClassTest.groovy".execute().text
...
/*DEZE WERKEN
        ...
        new GroovyShell().parse( new File( 'src/main//java/ETS1/GroovyClassTest.groovy' ) ).with {
            printEE1()
        }
        new GroovyShell().parse( new File( 'src/main//java/ETS1/GroovyClassTest.groovy') ).with {
            Step1gct()
